...
uv run train.py  data.batch_size=32 tok_path="/local/home/jtempus/tokenisation_lp/lp_tokenizer/tokenizers_lp/lp_32768_finewebedu_data" #For 32k vocab models
